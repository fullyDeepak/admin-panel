...
export default function Booking({ towerOptions }: Props) {
  ...
  const { projectBookingStatus, deleteProjectStatusData } = useTowerUnitStore();
  return (
    <div className='flex flex-col gap-4'>
      <h3 className='my-4 text-2xl font-semibold'>Section: Booking</h3>
