...
export interface ProjectTaggingType extends FormProjectDataType {
...
interface FormState {
  projectFormDataRera: ProjectTaggingType;
  projectFormETLTagData: FormProjectETLTagDataType[];
  updateProjectFormDataRera: (_newDetails: Partial<ProjectTaggingType>) => void;
...
const initialStateProjectData: ProjectTaggingType = {
  isRERAProject: true,
  district: null,
  mandal: null,
  mandalSuggestion: [],
...
export const useProjectStore = create<FormState>((set, get) => ({
  // Initial state
