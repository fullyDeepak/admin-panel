          ...
          <section className='flex flex-col gap-2 '>
            <label className='flex flex-wrap items-center justify-between gap-5 '>
              ...
              <div className='flex flex-[5] items-center gap-5'>
                <input
                  className={`toggle ${tower.singleUnit ? 'toggle-success' : ''}`}
                  type='checkbox'
                  name='towerDoorNo'
                ...
                />{' '}
                <span>{tower.singleUnit ? 'True' : 'False'}</span>
              </div>
            </label>
            <div className='flex flex-wrap items-center justify-between gap-5 '>
              ...
              <div className='flex w-full flex-[5]'>
                <input
                  ...
                  name='towerPattern'
                  defaultValue={tower.towerPattern}
                  onChange={(e) =>
                    updateEditTowerFormData(
                      tower.id,
                      'towerPattern',
                ...
                <input
                  className={inputBoxClass}
                  name='floorPattern'
                  defaultValue={tower.floorPattern}
                  onChange={(e) =>
                    updateEditTowerFormData(
                      tower.id,
                      'floorPattern',
                ...
                <input
                  className={inputBoxClass}
                  name='unitPattern'
                  defaultValue={tower.unitPattern}
                  onChange={(e) =>
                    updateEditTowerFormData(
                      tower.id,
                      'unitPattern',
